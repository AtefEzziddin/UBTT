...
public class FlaskReaderLHand : MonoBehaviour
{
    ...
    //loop until recieved playerId from FlaskReader
    int loopContinue = 1;
    ...
    void Update()
    {
        if(loopContinue==1)
        {
            ...
            {
                loopContinue = 0;
                string url = "http://127.0.0.1:5000/hand?playerId=" + bodyInstance.playersList.players[0] + "&identifier=left";
