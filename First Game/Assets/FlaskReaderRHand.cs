...
public class FlaskReaderRHand : MonoBehaviour
{
    ...
    //will loop until playerId from FlaskReader recieved
    int loopContinue = 1;
    ...
    void Update()
    {
        if(loopContinue==1)
        {
            ...
            {
                loopContinue = 0;
                string url = "http://127.0.0.1:5000/hand?playerId=" + bodyInstance.playersList.players[0] + "&identifier=right";
